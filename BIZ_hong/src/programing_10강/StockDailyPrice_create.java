...
public class StockDailyPrice_create {
	public static void main(String[] args) throws Throwable {
		...
		stmt.execute("create table abc("+ //테이블 생성
	       ...
	       "prdy_vol  bigint,"+  //mysql은 long이 bigint /*  전일 거래량                                 */
	    ...
	    // Buy-in 제도 추가 (2012.1.16)
	        ...
	        "buyin_tod_tr_pbmn bigint,"+                 /* Buy-in 당일 체결 대금                        */
					...
					"PRIMARY KEY(stnd_iscd,bsop_date)"+ /*복합프라이머리키 주는 문법 mysql*/
