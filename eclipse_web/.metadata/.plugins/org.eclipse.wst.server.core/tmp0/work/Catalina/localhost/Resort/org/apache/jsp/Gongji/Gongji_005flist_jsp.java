 ...
 * Generated at: 2019-08-12 05:04:41 UTC
...
//	    if (totalLineCnt == 200) lastPage_firstLinkNum = 1;
    ...
    nextPage_firstLinkNum = firstLinkNum+stopLink;
      ...
      out.write("\t\t\t\t\t<!-- 글제목 클릭시 공지글 하나 보는 페이지로 가서 검색 가능하게 글번호도 보내줌 -->\r\n");
      out.write("\t\t\t\t\t<a href=\"?contentPage=Gongji/Gongji_view.jsp?keyId=");
      out.print(rset.getInt(1));
      out.write('"');
      out.write('>');
      out.print(title );
      out.write("</a>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td class=\"collum3\" style=\"width: 18vh;\">\r\n");
      out.write("\t\t\t\t<!-- 파일1이 있으면 파일 아이콘 출력 없으면 '파일1없음'출력 -->\r\n");
      out.write("\t\t\t\t");
...
if(rset.getString(6)!=null) {
      ...
      out.write("\r\n");
      out.write("\t\t<li>\r\n");
      out.write("        <a href=\"?contentPage=Gongji/Gongji_list.jsp?sendFirstLink=");
      ...
      out.write("</div>\r\n");
      out.write("<br>\r\n");
      out.write("<!-- 관리자로 접속(관리자로그인했으면 신규 버튼을 출력 -->\r\n");
 if( loginOK != null && loginOK.equals("yes") ){ 
      out.write("\r\n");
      out.write("<form action=\"?contentPage=Gongji/Gongji_insert.jsp\" method=\"POST\" style=\"width: 100%;\r\n");
