 ...
 * Generated at: 2019-07-12 09:58:56 UTC
...
public final class vote_005fcount_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t");
 while(rset.next()) {
			//out.print(String.valueOf(rset.getInt(3)).trim().length());
			//out.print(rset.getInt(3)+"<br>");
			if(rset.getInt(3) !=0) voteCnt = rset.getInt(4);
			voteRate = Math.round(((voteCnt/(double)totalVoter)*100)*100)/100.0;
		
      out.write("\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<a href=\"voterAge.jsp?toid=");
      ...
      out.print(voteRate );
      out.write("em ;height:1em ;background-color: #ff0000\"></div>\r\n");
      out.write("\t\t\t\t<span>");
      out.print(voteCnt );
      out.write('표');
      out.write(' ');
