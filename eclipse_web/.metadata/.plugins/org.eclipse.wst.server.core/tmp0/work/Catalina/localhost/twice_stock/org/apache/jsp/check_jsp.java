 ...
 * Generated at: 2019-07-17 09:18:26 UTC
...
return;
  ...
  // upload.jsp(hidden)로 부터 넘어온 값들을 구함
	...
	String orgfileName2 = request.getParameter("orgfileName2");
      ...
      out.print(subject );
      out.write("<br>\r\n");
      out.write("\t첨부파일(클릭시 다운로드)<br>\r\n");
      out.write("\t<!-- download.jsp 파일로 저장된 파일의 이름을 넘겨줌 -->\r\n");
      out.write("\t- 파일1 : <a href=\"download.jsp?fileName=");
      out.print(fileName1);
      out.write('"');
      out.write('>');
      out.print(orgfileName1 );
      out.write("</a><br>\r\n");
      out.write("\t- 파일2 : <a href=\"download.jsp?fileName=");
      out.print(fileName2);
      out.write('"');
      out.write('>');
