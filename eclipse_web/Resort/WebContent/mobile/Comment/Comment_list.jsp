...
// 				}
		...
		%>
			...
			<%} %>
				...
				<td class="collum4" style="text-align:center;" ><%=rset.getString(8) %></td>
    ...
    <%-- 이전 페이지 가는 링크 --%>
        ...
        <%
            for(int i=firstLinkNum; i<firstLinkNum+stopLink ; i++) {
                ...
                out.print("<li class=numA><a href=?contentPage=Comment/Comment_list.jsp?sendFirstLink="+firstLinkNum+"&from="+(i*toCnt-(toCnt-1))+">"+i+"</a>");   
                out.print("</li>");                    
            }
        %>
        <%-- 다음페이지 넘어가기 링크 --%>
