...
<%
	...
	//String uploadPath = request.getRealPath("upload_imgs"); // upload는 폴더명 
	String uploadPath = "C:\\Users\\admin\\eclipse_web\\twice_stock\\WebContent\\upload_imgs"; // upload는 폴더명
	// 폴더의 경로를 구해옴
